...
<body class="sub-page">
    ...
    <nav class="navbar navbar-default navbar-fixed-top">
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand page-scroll" href="#page-top">新增日志</a>
            </div>
	...
	<!-- /////////////////////////////////////////Content -->
		...
		<div class="container">
			<div class="row">
				<div id="main-content">
				<form class="signup_form_form" id="sign_form" method="post" action="ArticleServlet.do?op=add" onsubmit="return doCheck();" enctype="multipart/form-data">
					<article>	
						<div>
							<div> 
								标题：<textarea  rows="5" cols="97" style="margin-left:2px;width:500px;height:50px;" name="title" id="title"></textarea>
							</div>
						</div>
						<div class="art-content">
							<div>概述：<textarea  rows="5" cols="97" style="margin-left:2px;width:760px;height:100px;" name="summarize" id="summarize"></textarea>
							</div>
							<div>图片：<input type="file" id="photo" name="photo"/>
							</div>
						<div>
							内容：<textarea  rows="1" cols="30" style="margin-left:2px;width:800px;height:300px;" name="content" id="myEditor"></textarea>
							<script>
